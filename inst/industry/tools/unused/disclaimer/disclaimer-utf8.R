...
output$html_territories <- renderText({
  ...
  paste0('<br>',
        ...
        '<p>Responsabilité (pour le document référencé)',
        '<div>Ce document et toute carte qu\'il peut comprendre sont sans préjudice du statut de tout territoire, de la souveraineté s\'exerçant sur ce dernier, du tracé des frontières et limites internationales, et du nom de tout territoire, ville ou région.</div></p>',
         '<br>',
         '<br>'
        )
})
...
output$html_israel <- renderText({
  ...
  paste0('<br>',
        ...
        '<p>Informations sur les données concernant Israël dans les documents et les publications de l\'OCDE',
        '<div>Les données statistiques concernant Israël sont fournies par et sous la responsabilité des autorités israéliennes compétentes. L\'utilisation de ces données par l\'OCDE est sans préjudice du statut des hauteurs du Golan, de Jérusalem Est et des colonies de peuplement israéliennes en Cisjordanie aux termes du droit international.</div></p>',
         '<br>',
         '<br>'
         )
})

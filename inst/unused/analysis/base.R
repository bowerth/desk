...
## setwd('C:\\Users\\werth_b\\LocalData\\Dropbox\\GitHub\\radiant\\inst\\marketing')
##
## input <- list(nav_radiant = "Base",
##               datasets = "diamonds",
##               sm_var = "price",
...
##               sm_compValue = 0)
##
## menu_name = "SingleMean"                      # menu_name
## fun_name = "SingleMean"                       # fun_name
## rfun_label = ".singleMean"                    # rfun_label
## fun_label = "singleMean"                      # fun_label
...
.singleMean <- reactive({
    ...
    singleMean(datasets = input$datasets,
               sm_var = input$sm_var,
               sm_compValue = input$sm_compValue,
               sm_alternative = input$sm_alternative,
               sm_sigLevel = input$sm_sigLevel)
})
...
## isolate(singleMean(datasets = input$datasets, sm_var = input$sm_var))
